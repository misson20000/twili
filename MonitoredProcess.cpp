...
trn::Result<std::nullopt_t> MonitoredProcess::GenerateCrashReport(ELFCrashReport &report, usb::USBBridge::USBResponseWriter &writer) {
	...
	auto r = Process::GenerateCrashReport(report, writer);
	Terminate();
	return r;
}
